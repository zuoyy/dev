...
import com.zuoyy.common.config.properties.ProjectProperties;
import com.zuoyy.common.enums.ResultEnum;
import com.zuoyy.common.exception.ResultException;
import com.zuoyy.common.utils.CaptchaUtil;
...
public class LoginController extends BaseController implements ErrorController {
    ...
    public JsonResponse login(String username, String password, String captcha, String rememberMe) {
        // 判断账号密码是否为空
        ...
        if (properties.isCaptchaOpen()) {
            if (StringUtils.isEmpty(captcha)) {
                throw new ResultException(ResultEnum.USER_CAPTCHA_NULL);
            }
        ...
        try {
            ...
            if (roleService.existsUserOk(user.getId())) {
                ...
                return JsonResponse.error("您不是后台管理员！");
            }
        } catch (LockedAccountException e) {
            return JsonResponse.error("该账号已被冻结");
