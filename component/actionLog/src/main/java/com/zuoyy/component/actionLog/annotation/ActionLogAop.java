...
import com.zuoyy.component.actionLog.action.model.ActionModel;
import com.zuoyy.component.actionLog.action.model.BusinessMethod;
import com.zuoyy.component.actionLog.action.model.BusinessType;
...
public class ActionLogAop {
    ...
    @Pointcut("@annotation(com.zuoyy.component.actionLog.annotation.ActionLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        com.zuoyy.component.actionLog.annotation.ActionLog anno =
                targetMethod.getAnnotation(com.zuoyy.component.actionLog.annotation.ActionLog.class);
        // 获取name值
