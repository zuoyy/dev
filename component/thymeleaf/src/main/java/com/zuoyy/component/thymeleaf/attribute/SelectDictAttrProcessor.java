package com.zuoyy.component.thymeleaf.attribute;
...
public class SelectDictAttrProcessor extends AbstractAttributeTagProcessor {
    ...
    public static final String SELECTED_ATTR_NAME= "zy-selected";
    public static final String EMPTY_ATTR_NAME= "zy-empty";
