...
public interface PayService<PC extends PayConfigStorage> {
     ...
     *
     * @param handler 消息处理器
     *                配合{@link  com.zuoyy.component.pay.common.api.PayService#payBack(java.util.Map, java.io.InputStream)}进行使用
     *                <p>
     *                默认使用{@link  com.zuoyy.component.pay.common.api.DefaultPayMessageHandler }进行实现
     */
