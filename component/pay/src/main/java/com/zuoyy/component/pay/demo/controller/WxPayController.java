...
import com.zuoyy.component.pay.weixin.api.WxPayConfigStorage;
import com.zuoyy.component.pay.weixin.api.WxPayService;
import com.zuoyy.component.pay.weixin.bean.WxBank;
...
//        return service.buildRequest(orderInfo, MethodType.POST);
     ...
     *                       .....这里没办法了只能这样写(┬＿┬)，请见谅
     *                       {@link com.zuoyy.component.pay.weixin.bean.WxTransferType#QUERY_BANK}
     *                       {@link com.zuoyy.component.pay.weixin.bean.WxTransferType#GETTRANSFERINFO}
     * <p>
