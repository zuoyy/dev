package com.zuoyy.component.pay.weixin.api;

import com.alibaba.fastjson.JSONObject;
import com.zuoyy.component.pay.common.api.BasePayService;
import com.zuoyy.component.pay.common.api.Callback;
import com.zuoyy.component.pay.common.bean.*;
import com.zuoyy.component.pay.common.bean.result.PayException;
...
import com.zuoyy.component.pay.common.util.DateUtils;
import com.zuoyy.component.pay.common.util.MatrixToImageWriter;
import com.zuoyy.component.pay.common.util.Util;
import com.zuoyy.component.pay.common.util.sign.SignUtils;
import com.zuoyy.component.pay.common.util.sign.encrypt.RSA2;
import com.zuoyy.component.pay.common.util.str.StringUtils;
import com.zuoyy.component.pay.weixin.bean.WxPayError;
import com.zuoyy.component.pay.weixin.bean.WxPayMessage;
import com.zuoyy.component.pay.weixin.bean.WxTransactionType;
import com.zuoyy.component.pay.common.util.XML;
import com.zuoyy.component.pay.weixin.bean.WxTransferType;
...
import static com.zuoyy.component.pay.weixin.bean.WxTransferType.*;
...
//        parameters.put("detail", order.getBody());
     ...
     *
     * @param outNo          商户转账订单号
     * @param wxTransferType 微信转账类型，.....这里没办法了只能这样写(┬＿┬)，请见谅 {@link com.zuoyy.component.pay.weixin.bean.WxTransferType}
     *                       <p>
     *                       <p>
    ...
    public Map<String, Object> transferQuery(String outNo, String wxTransferType) {
        ...
        if (StringUtils.isEmpty(wxTransferType)) {
            throw new PayErrorException(new WxPayError(FAILURE, "微信转账类型 #transferQuery(String outNo, String wxTransferType) 必填，详情com.zuoyy.component.pay.weixin.bean.WxTransferType"));
        }
        //如果类型为余额方式
