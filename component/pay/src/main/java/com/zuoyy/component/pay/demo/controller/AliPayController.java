package com.zuoyy.component.pay.demo.controller;


import com.zuoyy.component.pay.ali.api.AliPayConfigStorage;
import com.zuoyy.component.pay.ali.api.AliPayService;
import com.zuoyy.component.pay.ali.bean.AliTransactionType;
import com.zuoyy.component.pay.ali.bean.AliTransferType;
import com.zuoyy.component.pay.ali.bean.OrderSettle;
import com.zuoyy.component.pay.common.bean.PayOrder;
import com.zuoyy.component.pay.common.bean.RefundOrder;
import com.zuoyy.component.pay.common.bean.TransactionType;
import com.zuoyy.component.pay.common.bean.TransferOrder;
import com.zuoyy.component.pay.common.http.HttpConfigStorage;
import com.zuoyy.component.pay.common.http.UriVariables;
import com.zuoyy.component.pay.common.util.sign.SignUtils;
import com.zuoyy.component.pay.demo.handler.AliPayMessageHandler;
import com.zuoyy.component.pay.demo.interceptor.AliPayMessageInterceptor;
import com.zuoyy.component.pay.demo.query.QueryOrder;
...
//        PayOrder order = new PayOrder("egan order", "egan order", null == price ? new BigDecimal(0.01) : price, UUID.randomUUID().toString().replace("-", ""), AliTransactionType.WAVE_CODE);
     ...
     * @param request 请求
     * @return 返回对应的响应码
     * 业务处理在对应的PayMessageHandler里面处理，在哪里设置PayMessageHandler，详情查看{@link com.zuoyy.component.pay.common.api.PayService#setPayMessageHandler(com.zuoyy.component.pay.common.api.PayMessageHandler)}
     * 如果未设置 {@link com.zuoyy.component.pay.common.api.PayMessageHandler} 那么会使用默认的 {@link com.zuoyy.component.pay.common.api.DefaultPayMessageHandler}
     * @throws IOException IOException
     */
