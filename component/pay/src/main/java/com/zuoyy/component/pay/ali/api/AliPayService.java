...
import com.zuoyy.component.pay.ali.bean.AliPayMessage;
...
public class AliPayService extends BasePayService<AliPayConfigStorage> {
     ...
     * @see #refund(RefundOrder, com.zuoyy.component.pay.common.api.Callback)
     *  @deprecated 版本替代 {@link #refund(RefundOrder, com.zuoyy.component.pay.common.api.Callback)}
     */
    @Deprecated
    @Override
