...
import com.zuoyy.component.pay.common.http.HttpRequestTemplate;
...
public abstract class BasePayService<PC extends PayConfigStorage> implements PayService<PC> {
    ...
    protected String authorizationString(String user, String password) {
        ...
        try {
            base64ClientID = com.zuoyy.component.pay.common.util.sign.encrypt.Base64.encode(String.format("%s:%s", user, password).getBytes("UTF-8"));
