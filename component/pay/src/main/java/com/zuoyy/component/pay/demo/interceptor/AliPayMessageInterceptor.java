...
package com.zuoyy.component.pay.demo.interceptor;

import com.zuoyy.component.pay.ali.api.AliPayService;
import com.zuoyy.component.pay.ali.bean.AliPayMessage;
import com.zuoyy.component.pay.common.api.PayMessageInterceptor;
...
public class AliPayMessageInterceptor implements PayMessageInterceptor<AliPayMessage, AliPayService> {
     ...
     */
    @Override
    public boolean intercept(AliPayMessage payMessage, Map context, AliPayService payService) throws PayErrorException {
