package com.zuoyy.component.shiro.exception;
...
public class AuthorizationExceptionHandler {
    ...
    @ResponseBody
    public JsonResponse authorizationException(AuthorizationException e, HttpServletRequest request,
        ...
        Class<JsonResponse> resultVoClass = JsonResponse.class;
